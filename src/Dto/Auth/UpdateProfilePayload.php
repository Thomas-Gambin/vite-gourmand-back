...
final class UpdateProfilePayload
{
    public function __construct(
        ...
        #[Assert\Length(max: 50, maxMessage: 'La ville doit contenir au maximum {{ limit }} caractères.')]
        public readonly string $ville,

        #[Assert\NotBlank(message: 'Le pays est obligatoire.')]
        #[Assert\Length(max: 50, maxMessage: 'Le pays doit contenir au maximum {{ limit }} caractères.')]
        public readonly string $pays,

        #[Assert\NotBlank(message: "L'adresse postale est obligatoire.")]
        #[Assert\Length(max: 50, maxMessage: "L'adresse postale doit contenir au maximum {{ limit }} caractères.")]
